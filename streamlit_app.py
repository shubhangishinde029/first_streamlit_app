...
def get_fruityvice_data(this_fruit_choice):
    ...
    fruityvice_normalized = pandas.json_normalization(fruityvice_response.json())
...
add_my_fruit = streamlit.text_input('What fruit would you like information to add?')
